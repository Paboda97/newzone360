...
const Header = () => {
  return (
    <div className="w-full h-auto lg:h-32 flex justify-center items-center shadow-md">
      <header className="w-full max-w-screen-xl px-4 md:px-8 flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-0">
        ...
        <div className="flex flex-col items-start w-full lg:w-3/5 xl:w-1/2"> 
          <div className="flex items-center w-full">
            ...
            />
            <button className="bg-purple-600 h-10 px-4 py-2 rounded-r-md text-white hover:bg-purple-700 transition-all duration-300">
              <FaSearch />
            </button>
          </div>
          ...
          <div className="mt-2 text-sm flex flex-wrap items-center gap-1"> 
            {["Smart watch", "Phone Accessories", "Speakers & Sub", "Earbuds", "Back covers"].map((item, index, arr) => (
              <React.Fragment key={index}>
                <a
                  href="#"
                  className="text-gray-700 hover:underline transition-all duration-200"
                >
                  {item}
                </a>
...
const IconWithLabel = ({ icon, label }) => (
  <div className="flex flex-col items-center">
    <div className="text-black-600 hover:text-purple-800 transition-colors duration-300">
      {icon}
    </div>
